...
// excluído e tem o nome travado nas Configurações. Hoje são quatro —
// Indicações, Upgrade, Renovações e Vencidos — e a checagem vive aqui para
// não espalhar a condição pelas telas.

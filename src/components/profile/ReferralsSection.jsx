...
// isClientLead) — desfazer uma Venda reflete aqui sozinho, sem campo gravado.
  ...
  if (!items || items.length === 0) {
    return (
      <section className="rounded-2xl border border-border bg-card shadow-card px-8 py-12 text-center">
        ...
        <p className="text-[12.5px] text-muted-foreground mt-1 max-w-[380px] mx-auto leading-relaxed">
          Ao cadastrar um lead novo, ligue o interruptor “É uma indicação?” e escolha este cliente — os indicados aparecem aqui com o andamento de cada um.
        </p>
      </section>
    );
  }

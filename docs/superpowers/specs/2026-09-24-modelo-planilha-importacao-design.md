...
- **Data** usa o formato `dd/mm/yyyy` (código do Excel, que aparece como 15/03/2026) e uma validação de data entre 01/01/1900 e 31/12/2100, travada, com a mensagem "Digite uma data, como 15/03/2026." Na coluna Fim, uma validação só exige data dentro dos mesmos limites e, com o Início da mesma linha preenchido, data igual ou posterior a ele, com a mensagem "O fim precisa ser uma data igual ou depois do início, como 15/03/2026." Os limites vão como `Date` em meia-noite UTC e chegam ao arquivo como os seriais 1 e 73415 do Excel. O ExcelJS lê número como milissegundos desde 1970 e converte `Date` pela hora UTC, então número ou `Date` em meia-noite local sairiam errados.
